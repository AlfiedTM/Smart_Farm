...
<head>
    ...
    <title>Nitrogen Record | Smart Farming System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Today's Nitrogen Data</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Today's <span class="table-project-n"></span> Nitrogen Data</h1>
  ...
  <!-- <h4 class="align-center" style="margin-bottom: 30px">Result against "<?php #cho $sdata;?>" keyword </h4> -->
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                              ...
                                              <?php
                                              // Query the database
                                              $sql="SELECT Nitrogen, Time from farm_data where date ='".date("Y-m-d")."' ORDER BY ID DESC";
                                              ...
                                              ?>
                                                ...
                                                <!-- Output data collected as a table -->
                                                    ...
                                                    <td style="text-align: center"><?php  echo $row['Nitrogen']." mg/Kg";?> </td>
