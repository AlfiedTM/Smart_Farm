  ...
  <body class="materialdesign">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <ul class="breadcome-menu">
                      ...
                      <li><span class="bread-blod">Delete Plnat Record</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="sparkline13-list shadow-reset">
                <div class="sparkline13-hd">
                  <div class="main-sparkline13-hd">
                    <h1>Delete <span class="table-project-n"></span> Plant Record</h1>
                    ...
                    <form action="" method="post">
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT * FROM plant_records  ORDER BY ID ASC";
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" action="">
                <input type="hidden" class="recordid" name="recordid">
            ...
            <div class="modal-footer">
              ...
              <button type="button" style="background:black; color:white" data-id="<?php echo  $ids; ?>" id="Delete" class="btn btn-danger btn-flat deleterec" name="delete"><i class="fa fa-trash"></i> Delete</button>
              </form>
    ...
    <script>
      ...
      function deleteRow(id) {
        $.ajax({
          type: 'POST',
          url: 'plant-delete.php',
          data: {
            id: id
          },
          dataType: 'json',
          success: function() {
            document.location = 'delete-plant-record.php';
          }
        })
      }
      ...
      function getRow(id) {
        $.ajax({
          ...
          success: function(response) {
            $('.fullname').html(response.Plant_name);
            $('.recordid').html(response.ID);
            $('.deleterec').val(response.ID);
          }
        });
      }
    </script>
