  ...
  header('location:logout.php');
                  ...
                  if(isset($_POST['submit'])){
                    ...
                    //   Collect data from the form
                      ...
                      $wtr_H = (float)dataVerification($_POST['Highest_Water_Level']);
                      $wtr_L = (float)dataVerification($_POST['Lowest_Water_Level']);
                    ...
                    $sql = "UPDATE plant_records SET Plant_name ='$name', Ph_high='$ph_H', Ph_low='$ph_L', Temp_high='$tmp_H', Temp_low='$tmp_L', Moisture_high='$wtr_H',  Moisture_low='$wtr_L', Nitrogen='$nitrogen', Phosphorus='$phosphorus', Potassium='$potassium' where ID='$id'";
                    if($Conn->query($sql)){
