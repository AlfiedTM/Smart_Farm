...
//   Else display this
    ...
    // If data export required
    if(isset($_GET['export'])){
      // Redirect to print reports
...
<head>
    ...
    <title>Data Records | Smart Farming System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Irrigation Records</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
   ...
   <h4 class="align-center "></h4>
                                        <table class="table table-bordered table-hover" style="background-color: white; " >
                                            ...
                                            <tbody id="table2">
                                              ...
                                              <?php
                                                $today = date("Y-m-d");
                                                $sql="SELECT * from farm_data ORDER BY ID DESC";
                                                // Query the database
                                                $query = $Conn -> query($sql);
                                                $cnt=1;
                                                if($query->num_rows > 0){
                                                  // Fetch data as an array and iterate over it
                                                  while($row = $query->fetch_assoc()){
                                              ?>
                                                <tr class="text-center">
                                                <!-- Dsiaplay fetched data -->
