...
<head>
    ...
    <title>Temperature Record | Smart Farming System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Today's Temperature Data</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Today's <span class="table-project-n"></span> Temperature Data</h1>
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Temperature Value</th>
                                            ...
                                            <tbody>
                                              ...
                                              <?php
                                              // Query the database
                                              $sql="SELECT Temperature , Time from farm_data where Date ='".date("Y-m-d")."' ORDER BY ID DESC";
