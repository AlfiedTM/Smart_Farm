         ...
         <div class="left-sidebar-pro" style="color:white">
             <nav id="sidebar">
                 <div class="sidebar-header" style="color:white">
                     ...
                     <?php
                        $aid = $_SESSION['smaid'];
                        $sql = "SELECT Admin_username, Admin_email from  manager where ID='$aid'";
                 ...
                 <div class="left-custom-menu-adp-wrap" style="background-color: #222d32">
                     <ul class="nav navbar-nav left-sidebar-menu-pro">
                         ...
                         <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-cog"></i> <span class="mini-dn">Manage Accounts</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                             <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                 <a href="register.php" class="dropdown-item">Create New Account</a>
